            ...
            <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('team_lead.projects*') ? 'active' : '' }}" 
                               href="{{ route('team_lead.dashboard') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('team_lead.cards*') ? 'active' : '' }}" 
                               href="#">
                                <i class="bi bi-kanban"></i> Cards Management
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('help-requests*') ? 'active' : '' }}" 
                               href="{{ route('help-requests.index') }}">
                                <i class="bi bi-question-circle"></i> Help Requests
                            </a>
                        </li>
