...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="mb-1"><i class="bi bi-palette"></i> Dashboard Designer</h2>
                                                ...
                                                <div class="bg-light rounded p-3">
                                                    <div class="d-flex flex-wrap justify-content-between align-items-center mb-2 gap-2">
                                                        ...
                                                        <div class="d-flex gap-2">
                                                            <button class="btn btn-outline-secondary btn-sm" type="button" data-bs-toggle="collapse" data-bs-target="#designerSubtaskComments{{ $subtask->subtask_id }}">
                                                                <i class="bi bi-chat-dots"></i> Tampilkan Komentar
                                                            </button>
                                                            <button class="btn btn-outline-primary btn-sm" type="button" data-bs-toggle="collapse" data-bs-target="#designerSubtaskCommentForm{{ $subtask->subtask_id }}">
                                                                <i class="bi bi-pencil-square"></i> Tambah Komentar
                                                            </button>
                                                        </div>
                                                    </div>

                                                    <div class="collapse" id="designerSubtaskCommentForm{{ $subtask->subtask_id }}">
                                                        <form action="{{ route('comments.subtask.store', $subtask->subtask_id) }}" method="POST" class="card card-body border-0 shadow-sm mb-3">
                                                            ...
                                                            <div class="d-flex justify-content-end gap-2">
                                                                <button type="button" class="btn btn-light btn-sm" data-bs-toggle="collapse" data-bs-target="#designerSubtaskCommentForm{{ $subtask->subtask_id }}">Batal</button>
                                                    ...
                                                    <div class="collapse" id="designerSubtaskComments{{ $subtask->subtask_id }}">
